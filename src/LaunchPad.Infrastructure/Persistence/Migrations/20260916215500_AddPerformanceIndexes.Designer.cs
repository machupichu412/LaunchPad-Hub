...
namespace LaunchPad.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260916215500_AddPerformanceIndexes")]
            ...
            modelBuilder.Entity("LaunchPad.Domain.Entities.Deliverable", b =>
                {
                    ...
                    b.HasIndex("AssignmentId", "SubmittedUtc")
            ...
            modelBuilder.Entity("LaunchPad.Domain.Entities.Notification", b =>
                {
                    ...
                    b.HasIndex("RecipientAppUserId", "CreatedUtc")
                        .IsDescending(false, true)
            ...
            modelBuilder.Entity("LaunchPad.Domain.Entities.Project", b =>
                {
                    ...
                    b.HasIndex("CohortId", "Status", "ApprovalStatus")
                        .HasDatabaseName("IX_Project_Cohort_Status_Approval");

                    b.ToTable("Project", (string)null);
                });

            modelBuilder.Entity("LaunchPad.Domain.Entities.ProjectDeliveryKpi", b =>
                {
                    b.Property<int>("BusinessValueDocumentedCount")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("PilotReadyCount")
                        .HasColumnType("int");
                    ...
                    b.ToView("vProjectDeliveryKpi", (string)null);
                });
            ...
            modelBuilder.Entity("LaunchPad.Domain.Entities.Review", b =>
                {
                    ...
                    b.HasIndex("ReviewType", "Checkpoint", "SubmittedUtc")
